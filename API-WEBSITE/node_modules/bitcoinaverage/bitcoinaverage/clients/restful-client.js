...
module.exports = {
    RestfulClient: function (publicKey) {
        ...
        this.getResource = function (resourcePath, handleResponseCallback, errorCallback) {
            ...
            return common.getResourceForFullUrl(fullUrl, this.publicKey, handleResponseCallback, errorCallback);
        };
         ...
         * @param resolution - day, hour or minute, what type of data resolution to retrieve
         * @param handleResponseCallback
         * @param errorCallback
         */
        this.dataSinceTimestamp = function (market, symbol, since, resolution, handleResponseCallback, errorCallback) {

            since = since || '';
            if (typeof resolution === "function") {
                // function call without resolution parameter
                errorCallback = handleResponseCallback;
                handleResponseCallback = resolution;
                resolution = '';
            }
            resolution = resolution || '';
            var url = 'indices/' + market + '/history/' + symbol + '?since=' + since + "&resolution=" + resolution;
            return this.getResource(url, handleResponseCallback, errorCallback);
        };
         ...
         * @param errorCallback
         */
        this.dataSinceTimestampLocal = function (symbol, since, resolution, handleResponseCallback, errorCallback) {
            return this.dataSinceTimestamp('local', symbol, since, resolution, handleResponseCallback, errorCallback);
        };
         ...
         * @param errorCallback
         */
        this.dataSinceTimestampGlobal = function (symbol, since, resolution, handleResponseCallback, errorCallback) {
         ...
         * @returns {*}
         */
        this.priceAtTimestamp = function (market, symbol, timestamp, resolution, handleResponseCallback, errorCallback) {
            if (typeof resolution === "function") {
                // function call without resolution parameter
                errorCallback = handleResponseCallback;
                handleResponseCallback = resolution;
            ...
            resolution = resolution || '';
            var url = 'indices/' + market + '/history/' + symbol + '?at=' + timestamp + "&resolution=" + resolution;
            return this.getResource(url, handleResponseCallback, errorCallback);
        };
         ...
         * @returns {*}
         */
        this.priceAtTimestampLocal = function (symbol, timestamp, resolution, handleResponseCallback, errorCallback) {
            return this.priceAtTimestamp('local', symbol, timestamp, resolution, handleResponseCallback, errorCallback);
        };
         ...
         * @returns {*}
         */
        this.priceAtTimestampGlobal = function (symbol, timestamp, resolution, handleResponseCallback, errorCallback) {
            return this.priceAtTimestamp('global', symbol, timestamp, resolution, handleResponseCallback, errorCallback);
        };
        ...
        /**
         * Returns ticket used in the websocket v2 authentication process.
         * @param handleResponseCallback
         * @param errorCallback
         */
        this.getTicketV2 = function (handleResponseCallback, errorCallback) {
            var ticketUrl = config.BASE_URL_V2 + 'get_ticket';
            return common.getResourceForFullUrl(ticketUrl, this.publicKey, handleResponseCallback, errorCallback);
        };
